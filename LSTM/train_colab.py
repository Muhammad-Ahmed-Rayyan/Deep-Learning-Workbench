"""
train_colab.py - Long Short-Term Memory (LSTM) on IMDB Reviews

Task: Binary sentiment classification (positive/negative) of movie reviews.
Identical setup to the RNN project (same preprocessing, vocab, hyperparameters)
with nn.RNN replaced by nn.LSTM — isolates the effect of gating on long-sequence
performance for direct comparison.

Run this file in Google Colab (GPU) after cloning the repo.
"""
